                        ...
                        <div class="navigation-area">
                            <div class="header-navigation-left">
                                ...
                                <div class="site-branding">
                                    <a href="index.html">
                                        <img src="{{ asset('assets/web/images/logo/logo.png') }}" alt="Site Logo" />
                                    </a>
                                </div><!--  /.site-branding -->
                                                        ...
                                                        <div class="sub-menu megamenu-main megamenu-carousel carousel-nav-text owl-carousel">
                                                            <a href="#" class="cat-item cat-nightlife">
                                                                <figure class="cat-thumb">
                                                                    <img src="{{ asset('assets/web/images/categories/component/1.jpg') }}" alt="Thmubnail">
                                                                </figure><!--./ cat-thumb -->
                                                            ...
                                                            <a href="#" class="cat-item cat-hotel">
                                                                <figure class="cat-thumb">
                                                                    <img src="{{ asset('assets/web/images/categories/component/2.jpg') }}" alt="Thmubnail">
                                                                </figure><!--./ cat-thumb -->
                                                            ...
                                                            <a href="#" class="cat-item cat-sopping">
                                                                <figure class="cat-thumb">
                                                                    <img src="{{ asset('assets/web/images/categories/component/3.jpg') }}" alt="Thmubnail">
                                                                </figure><!--./ cat-thumb -->
                                                            ...
                                                            <a href="#" class="cat-item cat-places">
                                                                <figure class="cat-thumb">
                                                                    <img src="{{ asset('assets/web/images/categories/component/4.jpg') }}" alt="Thmubnail">
                                                                </figure><!--./ cat-thumb -->
                            ...
                            <div class="header-navigation-right">
                                ...
                                <div class="add-listing-area">
                                    <a class="btn btn-default btn-black" href="dashboard-add-listing.html">add listing <span class="fas fa-caret-right"></span></a>
